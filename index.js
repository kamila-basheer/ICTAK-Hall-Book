...
App.post('/api/del-associate',verifyAdminToken, function(req,res){
    res.header("Access-Control-Allow-Origin", "*");
    res.header("Access-Control-Allow-Methods: GET, POST, PUT, DELETE");
...
// App.route("/book-hall")
App.post('/api/book-hall',verifyToken,(req,res)=>{
    res.header("Access-Contol-Allow-Origin","*");
    res.header("Access-Control-Allow-Methods: GET, POST, PUT, DELETE");
...
// App.route("/checkslot")
App.post('/api/checkslot', verifyToken, (req,res)=>{
    res.header("Access-Contol-Allow-Origin","*");
    res.header("Access-Control-Allow-Methods: GET, POST, PUT, DELETE");
...
App.get('/api/getbookingdetail', verifyToken, (req,res)=>{
    res.header("Access-Contol-Allow-Origin","*");
    res.header("Access-Control-Allow-Methods: GET, POST, PUT, DELETE");
var email = req.email;
...
App.post('/api/getbookingdetail', verifyToken, (req,res)=>{
    res.header("Access-Contol-Allow-Origin","*");
    res.header("Access-Control-Allow-Methods: GET, POST, PUT, DELETE");
var email = req.email;
bookings.find({"associateEmail":email},(err,data)=>{
...
App.get('/api/getbookingdetails', verifyAdminToken, (req,res)=>{
    res.header("Access-Contol-Allow-Origin","*");
    res.header("Access-Control-Allow-Methods: GET, POST, PUT, DELETE");
    var email = req.email;
    bookings.find({})
